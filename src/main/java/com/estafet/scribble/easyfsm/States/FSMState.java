...
import com.estafet.scribble.easyfsm.Common.*;
...
public class FSMState implements java.io.Serializable {
    ...
    private com.estafet.scribble.easyfsm.Common.CustomXMLReader _reader;
    ...
    public FSMState(String state, String configFileName) 
        ...
        this._reader = new com.estafet.scribble.easyfsm.Common.CustomXMLReader(
     ...
     */
    public void addMessageAction(String message, com.estafet.scribble.easyfsm.Action.FSMAction act) {
